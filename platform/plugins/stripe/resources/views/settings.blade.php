                ...
                <div class="col-sm-6">
                    <div class="well bg-white">
                        ...
                        <x-core-setting::form-group>
                            <label class="text-title-field" for="payment_stripe_image">{{ trans('core/base::forms.image') }}</label>
                            <textarea class="next-input form-control editor-ckeditor " name="payment_stripe_image" id="payment_stripe_image">{{ get_payment_setting('image', 'stripe', __('Payment with Stripe')) }}</textarea>
                        </x-core-setting::form-group>

                        <x-core-setting::form-group>
                            <label class="text-title-field" for="payment_stripe_description">{{ trans('core/base::forms.description') }}</label>
                            <textarea class="next-input form-control editor-ckeditor " name="payment_stripe_description" id="payment_stripe_description">{{ get_payment_setting('description', 'stripe', __('Payment with Stripe')) }}</textarea>
                        </x-core-setting::form-group>
                        ...
                        <x-core-setting::select
                            :name="'payment_' . STRIPE_PAYMENT_METHOD_NAME . '_payment_template'"
                            :label="__('Payment Template')"
                            :options="[
                                'template_1' => __('Template 1'),
                                'template_2' => __('Template 2'),
                            ]"
                            :value="get_payment_setting('payment_template', STRIPE_PAYMENT_METHOD_NAME, 'stripe_api_charge')"
                        />
