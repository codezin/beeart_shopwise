    ...
    <div class="max-width-1200">
        {!! Form::open(['url' => route('ecommerce.advanced-settings'), 'class' => 'main-setting-form']) !!}
            ...
            >
                ...
                <x-core-setting::text-input
                    name="shipping_title"
                    :label="trans('Shipping Title')"
                    :value="get_ecommerce_setting('shipping_title')"
                />

                <x-core-setting::form-group>
                    <label class="text-title-field" for="shipping_file">Shipping File Download</label>
                    {!! Form::mediaFile('shipping_file', get_ecommerce_setting('shipping_file'), []) !!}
                </x-core-setting::form-group>
            </x-core-setting::section>
