...
app()->booted(function () {
    theme_option()
        ...
        ->setField([
            'id' => 'allow_google_Search',
            'section_id' => 'opt-text-subsection-general',
            'type' => 'checkbox',
            'label' => __('Allow Google search'),
            'attributes' => [
                'name' => 'allow_google_Search',
                'value' => null,
                'options' => [
                    'class' => 'form-control',
        ...
        ->setField([
            'id' => 'product_social_link',
            'section_id' => 'opt-text-subsection-general',
            'type' => 'text',
            'label' => __('Social link in product detail page?'),
            'attributes' => [
                'name' => 'product_social_link',
                'value' => null,
                'options' => [
                    'class' => 'form-control',
