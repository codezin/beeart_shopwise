...
app()->booted(function () {
    ...
    add_shortcode('jangseang-contact-form', __('JangSeang Contact Form'), __('JangSeang Contact Form'), function ($shortcode) {
        return view('jangseang.contact-form', [
            'title' => $shortcode->title,
            'description' => $shortcode->description,
            'subtitle' => $shortcode->subtitle,
        ]);
    });
    add_shortcode('profile', __('Profile'), __('Profile'), function ($shortcode) {
        return view('profile', [
            'path' => $shortcode->title
        ]);
    });
});
