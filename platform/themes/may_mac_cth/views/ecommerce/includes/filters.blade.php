@php
    ...
    Theme::asset()
        ->container('footer')
        ->usePath()
        ->add('jquery-ui-js', 'js/jquery-ui.js', ['jquery']);
    Theme::asset()
        ->container('footer')
        ->usePath()
        ->add('touch-punch', 'js/jquery.ui.touch-punch.min.js', ['jquery-ui-js']);
...
@if (count($brands) > 0)
    <aside class="widget" style="margin-top:0;padding-top:0;border:0">
        <h5 class="widget_title">{{ __('Product brands') }}</h5>
...
<aside class="widget" >
    <h5 class="widget_title">{{ __('By Level Price') }}</h5>
