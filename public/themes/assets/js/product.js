   ...
   *===================================*/
    ...
    *===================================*/
    $(document).ready(function () {
        ...
        $('.btn-filter-star').on('click', function(){
            let rating = $(this).data('rating') ;
            $(".comment_list .rating_wrap .product_rate").each(function(){
                let width = $(this).attr("start");
        ...
        $('#searchReviewInput').on('input', function () {
            const search = $(this).val().toLowerCase();
            $('.comment_list .comment_block').each(function () {
