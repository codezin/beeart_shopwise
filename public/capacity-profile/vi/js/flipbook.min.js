...
!(function (e, t, o, i) {
    (e.fn.flipBook = function (e) {
        ...
        (e.fn.flipBook.options = {
            ...
            shareTitle: null,
            shareImage: null,
            whatsapp: { enabled: !0, icon: "flipbook-icon-whatsapp" },
            twitter: { enabled: !0, icon: "flipbook-icon-twitter" },
            facebook: { enabled: !0, icon: "flipbook-icon-facebook" },
            pinterest: { enabled: !0, icon: "flipbook-icon-pinterest-p" },
            email: { enabled: !0, icon: "flipbook-icon-envelope" },
            linkedin: { enabled: !0, icon: "flipbook-icon-linkedin" },
            digg: { enabled: !1, icon: "flipbook-icon-digg" },
            reddit: { enabled: !1, icon: "flipbook-icon-reddit-alien" },
        ...
        (FLIPBOOK.Main = function (e, i) {
            ...
            for (var c in p)
                e.skin == c && (e = jQuery.extend(!0, {}, p[c], e));
            for (var c in d)
                String(e.layout) === c && (e = jQuery.extend(!0, {}, d[c], e));
            this.options = jQuery.extend(!0, {}, jQuery.fn.flipBook.options, e);
            var u,
                g,
                b = this.options;
            if (
                ((b.isMobile = /iPhone|iPad|iPod|Android/i.test(
                    navigator.userAgent
                )),
                b.isMobile)
            )
            ...
            if (
                ...
                b.isMobile &&
                    ((b.singlePageMode =
                        !!b.singlePageModeIfMobile || b.singlePageMode),
                ...
                b.menuFloating &&
                    ((b.menuOverBook = !0), (b.sideMenuOverMenu = !0)),
                b.menu2Floating &&
                ...
                (b.pdfMode =
                    Boolean(b.pdfUrl && "" != b.pdfUrl) || b.pdfBase64),
                ...
                f.on("pageLoaded", function (e) {
                    ...
                    f.on("pageUnloaded", function (e) {
                        e.unloadedPages.forEach(function (e) {
                            if (n.Book.onPageUnloaded) {
                                var t = e.index;
                                n.options.cover || t++,
                                    n.Book.onPageUnloaded(t, e.size);
                            }
                        });
                    }),
                    f.on("pdfinit", function () {
                        (b.tableOfContent =
                            n.pdfService.outline || b.tableOfContent),
                    ...
                    b.lightBox
                        ? ((b.btnClose.enabled = !0),
                          ...
                          b.lightBoxOpened
                              ? (v(),
                                jQuery(t).trigger("r3d-lightboxloadingstarted"))
                              : b.lightboxPreload &&
                        ...
                        : ((b.btnClose.enabled = !1),
                          ...
                          P(this.wrapper[0])
                              ? v()
                              : (this.containerVisibleInterval = setInterval(
                                    function () {
                                        P(n.wrapper[0]) > 0 &&
                                            (clearInterval(
                                                n.containerVisibleInterval
                                            ),
                                            v());
                                    },
                                    300
            ...
            function k() {
                if (!n.disposed) {
                    ...
                    b.cover || o++,
                        ...
                        o < 1
                            ? (o = 1)
                            : n.numPages && o > n.numPages && (o = n.numPages),
                        o &&
                            ((o =
                            ...
                            (t.src = b.fillPreloader.imgFull),
                                (t.onload = function () {
                                    jQuery(e).appendTo(n.$fillPreloader),
                                        (n.$fillPreloaderImg = jQuery(
                                            t
                                        ).appendTo(n.$fillPreloader)),
        ...
        (FLIPBOOK.Main.prototype = {
            ...
            setHash: function (e) {
                e < 1 && (e = 1),
                    "#" + this.options.deeplinkingPrefix + e !=
                        t.location.hash &&
            ...
            updateCurrentPage: function () {
                ...
                if (
                    (s % 2 == 1 && s++,
                    o && (s = this.options.pages.length - s),
                    ...
                    1 == this.Book.view
                        ...
                        : (s > i || (s == i && i % 2 == 0)
                              ? ((e = i),
                                (this.cPage = [i - 1]),
                                this.options.cover ||
                                    ((e = String(s - 1) + "-" + String(s)),
                                    (this.cPage = [s - 2, s - 1])))
                              : s < 1
                              ? ((e = 1), (this.cPage = [0]))
                              : ((e = String(s) + "-" + String(s + 1)),
                                this.options.cover ||
                                    (e = String(s - 1) + "-" + String(s)),
                                (this.cPage = [s - 1, s])),
                          this.options.cover
                    ...
                    o
                        ? (this.enableNext(s > 0),
                          this.options.cover || this.enableNext(s > 2),
                          this.enablePrev(this.Book.canFlipPrev() || s < i - 1))
                        : (this.enablePrev(s > 0),
                          this.options.cover || this.enablePrev(s > 2),
                          this.enableNext(
                              this.Book.canFlipNext() || s < i - 1
                          )),
                    2 == this.cPage.length
                    ...
                    a &&
                        ...
                        r &&
                            ...
                            (e += "-" + this.options.pages[Number(r - 1)].name),
            ...
            initPdf: function () {
                if (!this.started) {
                    ...
                    if (
                        (e.options.pdfUrl
                            ? (!1 !== e.options.matchProtocol &&
                                  ("https:" == location.protocol
                                      ? (e.options.pdfUrl =
                                            e.options.pdfUrl.replace(
                                                "http://",
                                                "https://"
                                            ))
                              ...
                              (o.url = e.options.pdfUrl))
                            : e.options.pdfBase64 &&
                              (o.data = atob(e.options.pdfBase64)),
                    ...
                    this.options.pdfMode
                        ? this.options.pages[e]
                            ? this.pdfService.loadTextLayer(e, function (o) {
                                  i.initPageLinks(n.pages[e].htmlContent),
                                      t.call(i, n.pages[e].htmlContent, e);
                              })
                            : t.call(this, {})
                        : n.pages[e].json
                        ? this.loadPageJSON(e, function (s) {
                              ...
                              if (!a.htmlContentInitialized) {
                                  ...
                                  r.classList.add("flipbook-page-htmlContent"),
                                      ...
                                      (r.innerHTML = decodeURIComponent(
                                          s.data
                                      )),
                                      a.htmlContent &&
                                          jQuery(r).append(
                                              jQuery(a.htmlContent)
                                          ),
                                      (a.htmlContent = r),
                                      i.initPageLinks(a.htmlContent),
                                      (a.htmlContentInitialized = !0);
                              }
                              t.call(i, a.htmlContent, e);
                          })
                        : (this.initPageLinks(n.pages[e].htmlContent),
            ...
            mark: function (e, t) {
                (e != this.markedStr || t) &&
                    ...
                    this.options.pages.forEach(function (t) {
                        var o = jQuery(t.htmlContent).find(
                            ".flipbook-textLayer"
                        );
                        t.marked != e &&
                            o.length &&
            ...
            unmark: function () {
                (this.searchingString = null),
                    ...
                    this.options.pages.forEach(function (e) {
                        e.marked &&
                            ((e.marked = null), jQuery(e.htmlContent).unmark());
                    });
            },
            setTool: function (e) {
            ...
            createBook: function () {
                ...
                if (
                    (e.setLoadingProgress(0.9), "webgl" == e.options.viewMode)
                ) {
                ...
                if (
                    ...
                    if (e.options.backCover)
                        ...
                        (s = {
                            src: (r =
                                e.options.pages[e.options.pages.length - 1])
                                .src,
                            thumb: r.thumb,
                            title: r.title,
                            htmlContent: r.htmlContent,
                    ...
                    for (n = 0; n < e.options.pages.length; n++)
                        void 0 !== e.options.pages[n].htmlContent &&
                            ...
                            (e.options.pages[n].htmlContent = jQuery(
                                '<div class="flipbook-page-htmlContent">' +
                ...
                function l() {
                    e.options.flipSound &&
                        ...
                        e.options.backgroundMusic &&
                            (e.backgroundMusic = jQuery(
                ...
                if ("webgl" == e.options.viewMode) {
                    ...
                    (h.scroll = e.scroll),
                        (h.parent = e),
                        (e.Book = new FLIPBOOK.BookWebGL(e.book[0], t, h)),
                        (e.webglMode = !0),
                        e.initSwipe(),
                        l();
                } else
                    "swipe" == e.options.viewMode
                        ? ((e.Book = new FLIPBOOK.BookSwipe(
                          ...
                          e.initSwipe())
                        : ("2d" != e.options.viewMode &&
                              (e.options.viewMode = "3d"),
                    ...
                    if (((i.htmlContent = i.htmlContent || ""), i.items))
                        for (var n in i.items) {
                            ...
                            switch (
                                ...
                                case "link":
                                    (o = jQuery(
                                        '<a class="flipbook-page-item flipbook-page-item-link"></a>'
                                    )
                                        .width(s.width)
                                        .height(s.height)
                                        .css({
                    ...
                    (n =
                        "material" == this.options.icons
                            ? jQuery(o.createElement("span"))
                                  ...
                                  .addClass(
                                      "flipbook-icon flipbook-menu-btn skin-color"
                                  )
                            : jQuery(o.createElement("span"))
                                  .attr("aria-hidden", "true")
            ...
            createButton: function (e) {
                var t = this.options,
                    ...
                    n =
                        e.background ||
                        (i ? t.floatingBtnBackground : t.btnBackground),
                    s =
                        e.backgroundHover ||
                        (i
                            ? t.floatingBtnBackgroundHover
                            : t.btnBackgroundHover),
                    a = e.color || (i ? t.floatingBtnColor : t.btnColor),
                    r =
                        e.colorHover ||
                        (i ? t.floatingBtnColorHover : t.btnColorHover),
                ...
                (g.$icon = this.createIcon(e).appendTo(g)),
                    m(g.$icon),
                    e.iconAlt2 &&
                        ((g.$iconAlt = this.createIcon(e, !0)
                            .appendTo(g)
                            .hide()),
                        m(g.$iconAlt)),
                    (g.icon = e.iconFA),
                    (g.iconAlt = e.iconFA_alt),
                    b &&
                        ((g.icon = e.iconM),
                        (g.iconAlt = e.iconM_alt),
                        (e.icon = e.iconM),
                        (e.iconAlt = e.iconM_alt)),
                    e.onclick &&
                        g.bind("tap click", function (t) {
                            e.onclick();
                        }),
                    (r || s) &&
                        g
                    ...
                    (this.menuBottom = jQuery(o.createElement("div"))
                        ...
                        e.isMobile &&
                            ...
                            void 0 !== e.btnExpandIfMobile &&
                                (e.btnExpand.hideOnMobile =
                                    !e.btnExpandIfMobile),
                            void 0 !== e.btnPrintIfMobile &&
                                (e.btnPrint.hideOnMobile =
                                    !e.btnPrintIfMobile)),
                        e.sideNavigationButtons &&
                            ...
                            e.menuNavigationButtons ||
                                ...
                                e.btnOrder.indexOf("btnPrev") >= 0 &&
                                    e.btnOrder.splice(
                                        e.btnOrder.indexOf("btnPrev"),
                                        1
                                    ),
                                e.btnOrder.indexOf("btnNext") >= 0 &&
                                    e.btnOrder.splice(
                                        e.btnOrder.indexOf("btnNext"),
                                        1
                                    ),
                        ...
                        !e.pdfTextLayer &&
                            e.btnSelect &&
                            (e.btnSelect.enabled = !1),
                        !e.pdfTextLayer &&
                            e.btnSearch &&
                            (e.btnSearch.enabled = !1);
                        ...
                        e.isMobile && r.hideOnMobile && (r.enabled = !1),
                            r.enabled &&
                                ...
                                "currentPage" == r.name
                                    ...
                                    : (this[a] = this.createButton(r).bind(
                                          "touchend click",
                                          function (e) {
                                              e.stopPropagation(),
                                                  e.preventDefault(),
            ...
            createCurrentPage: function () {
                ...
                var s =
                    ...
                    d =
                        (s ? i.floatingBtnMargin : i.btnMargin,
                ...
                (this.currentPageInput = jQuery(
                    ...
                    .focus(function () {
                        t.currentPageInput.val(""),
                            t.currentPage.addClass(
                                "flipbook-color-transparent"
                            );
                    })
                    .blur(function () {
                        t.currentPageInput.val(""),
                            t.currentPage.removeClass(
                                "flipbook-color-transparent"
                            );
                    })),
            ...
            createToc: function () {
                ...
                if (
                    ...
                    e.pdfService.loadOutline(function (t) {
                        ...
                        new PDFLinkService({ eventBus: o }).setViewer(i),
                            e.createToc();
                    });
            },
                    ...
                    a = jQuery(o.createElement("a"))
                        ...
                        .bind("touchend click", function (t) {
                            if (
                                ...
                                if (
                                    (n.options.tableOfContentCloseOnClick &&
                                        n.toggleToc(!1),
                                    !e.page && e.dest)
                                ) {
                                    function o(e) {
            ...
            togglePrintMenu: function () {
                ...
                if (this.printMenu)
                    ...
                    var t = jQuery(
                            '<div class="flipbook-sub-menu-center">'
                ...
                if (this.shareMenu)
                    ...
                    var e = jQuery(o.createElement("div"))
                        ...
                        i = jQuery(o.createElement("div"))
                            .appendTo(e)
                            .addClass(
                                "flipbook-sub-menu-content skin-color-bg"
                            );
                    this.createMenuHeader(
                        i,
                    ...
                    var n = this.options,
                        s = jQuery(
                            '<div class="flipbook-share"><ul></ul></div>'
                        )
                            .appendTo(i)
                            .find("ul"),
                ...
                if (n)
                    if (n.print) i = n.print;
                        ...
                        if ("webgl" == this.options.viewMode) {
                            ...
                            (r.width = a.width),
                                (r.height = a.height),
                                a.scaleX && (r.width = a.width * a.scaleX),
                                a.scaleY && (r.height = a.height * a.scaleY),
                                "right" == n.side
                                    ? l.drawImage(
                                          a,
                                          r.width,
            ...
            togglePrintWindow: function (e) {
                ...
                if (e) i = e;
                    ...
                    if (o.options.pdfUrl)
                        return void o.printFile(o.options.pdfUrl);
                }
                !(function () {
                    ...
                    if ((n.document.open(), e)) i = '<img src="' + e + '"/>\n';
                        ...
                        for (var s = 0; s < o.options.pages.length; s++)
                            o.options.pages[s].src &&
                                (i +=
                                    '<img src="' +
                                    o.options.pages[s].src.toString() +
                                    '"/>\n');
                    var a = (function (e) {
                        return (
            ...
            initEasing: function () {
                t.jQuery.extend(t.jQuery.easing, {
                    ...
                    easeInBounce: function (e, t, o, i, n) {
                        return (
                            i -
                            jQuery.easing.easeOutBounce(e, n - t, 0, i, n) +
                            o
                        );
                    },
        ...
        (FLIPBOOK.Thumbnails = function (e) {
                        ...
                        if ("" != e) {
                            ...
                            if (
                                ...
                                for (a = 0; a < n.pagesOriginal.length; a++) {
                                    var r = a;
                                    n.doublePage && (r *= 2),
                                        o.loadPageHTML(r, function (i, s) {
                                            i.innerText
                                                .toUpperCase()
                                                .search(
                                                    o.searchingString.toUpperCase()
                                                ) > 0
                                                ? (n.doublePage && (s /= 2),
                                                  t.showThumb(s),
                                                  t.pagesFound++,
            ...
            for (r = 0; r < a.length; r++) {
                ...
                if (!a[r].empty) {
                    ...
                    if ((this.thumbs.push(p), a[r].thumbCanvas))
                        var u = jQuery(a[r].thumbCanvas);
                    else {
                        if (!d) continue;
                        (u = jQuery("<img/>").attr("src", d))[0].onload =
                            function () {
                    ...
                    if (g) {
                        ...
                        p.width(2 * h),
                            u
                                .height(l)
                                .width(2 * h)
                                .attr("page-title", 2 * r + 1);
                        jQuery(o.createElement("soan"))
                            .text(String(2 * r) + "-" + String(2 * r + 1))
                            .appendTo(p)
                            .addClass("skin-color")
                            .addClass("flipbook-thumb-num");
                    } else {
                        ...
                        this.options.pages[r] &&
                            this.options.pages[r].title &&
                            (m = this.options.pages[r].title);
                        jQuery(o.createElement("span"))
                            .text(m)
                            .appendTo(p)
                            .addClass("skin-color")
        ...
        (FLIPBOOK.Thumbnails.prototype = {
                ...
                this.main.pdfDocument.getPage(e + 1).then(function (e) {
                    ...
                    (e.cleanupAfterRender = !0),
                        e.render(l).promise.then(function () {
                            e.cleanup(),
                                e._pageIndex + 1 <
                                    o.main.pdfDocument._pdfInfo.numPages &&
            ...
            showSearchResults: function (e, t, o) {
                ...
                jQuery(
                    ...
                    .bind("tap click", function (e) {
                        e.stopPropagation(),
                            e.preventDefault(),
                            i.main.goToPage(this.dataset.page);
                    }),
            ...
            updateWrapperHeight: function () {
                var e = 50;
                "bookmarks" == this.active
                    ? (e += this.bookmark.height())
                    : "search" == this.active && (e += this.search.height()),
                    this.thumbsWrapper.css("top", e + "px");
            },
            show: function () {
                        ...
                        function (n) {
                            ...
                            (t = t || e.documentElement),
                                / Version\/5\.1(?:\.\d+)? Safari\//.test(
                                    ...
                                    ? t[s]()
                                    : t[s](
                                          o ? Element.ALLOW_KEYBOARD_INPUT : {}
                                      ),
                                this.on("change", a);
                        }.bind(this)
                    );
    ...
    (function (e) {
        ...
        function t(t, T) {
                ...
                if (
                    ...
                    if (
                        ...
                        return (
                            ...
                            q(),
                            Y(0, h),
                            !l || xe === T.fingers || T.fingers === m || R()
                                ? ((ye = se()),
                                  2 == xe &&
                                      (Y(1, l[1]),
                                      (fe = me = ie(Oe[0].start, Oe[1].start))),
                        ...
                        2 == xe &&
                            (0 == fe
                                ...
                                : (J(v[1]),
                                  ...
                                  Oe[1].end,
                                  (we = ke < 1 ? r : a)),
                            (ke = ((me / fe) * 1).toFixed(2)),
                            (ve = Math.abs(fe - me))),
                        xe === T.fingers || T.fingers === m || !v || R())
                    ) {
                        if (
                            ((ue = ne(B.start, B.end)),
                            (function (e, t) {
                                if (!1 !== T.preventDefaultEvents)
                                    if (T.allowPageScroll === l)
                                        e.preventDefault();
                                    else {
                            ...
                            !T.triggerOnTouchEnd && x
                                ? (Be = z(w))
                                : T.triggerOnTouchLeave && !x && (Be = z(P)),
                                (Be != S && Be != P) || E(g, Be);
                        }
                    } else E(g, (Be = S));
                    !1 === k && E(g, (Be = S));
                ...
                if (h == d) {
                    ...
                    if (l == P && N()) {
                        if (
                            (clearTimeout(Ie),
                            clearTimeout(Fe),
                            Se.trigger("swipe", [ue, ce, be, xe, Oe, ge]),
                            T.swipe &&
                                !1 ===
                                    (b = T.swipe.call(
                                        Se,
                        ...
                        switch (ue) {
                            ...
                            case i:
                                ...
                                break;
                            case n:
                                Se.trigger("swipeUp", [ue, ce, be, xe, Oe, ge]),
                                    T.swipeUp &&
                                        (b = T.swipeUp.call(
                                            Se,
                                            t,
                    ...
                    h == c
                        ? (l !== S && l !== P) ||
                          ...
                          $() && !Z()
                              ...
                              : ((Le = null),
                                Se.trigger("tap", [t.target]),
                                T.tap && (b = T.tap.call(Se, t, t.target))))
                        : h == u
                        ? (l !== S && l !== P) ||
                          (clearTimeout(Ie),
                          clearTimeout(Fe),
                          ...
                          T.doubleTap &&
                              (b = T.doubleTap.call(Se, t, t.target)))
                        : h == g &&
                          ((l !== S && l !== P) ||
                              (clearTimeout(Ie),
                              (Le = null),
                              ...
                              T.longTap &&
                                  (b = T.longTap.call(Se, t, t.target)))),
                    b
                );
            }
            function Q() {
            ...
            function X(e) {
                Se &&
                    (!0 === e
                        ? (Se.bind(le, C), Se.bind(he, L), de && Se.bind(de, F))
                        : (Se.unbind(le, C, !1),
                          Se.unbind(he, L, !1),
                          de && Se.unbind(de, F, !1)),
                    Se.data(y + "_intouch", !0 === e));
            }
            function Y(e, t) {
                var o = {
                    start: { x: 0, y: 0 },
            ...
            try {
                ...
                e.error(
                    "events not supported " + re + "," + pe + " on jQuery.swipe"
                );
            }
